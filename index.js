...
// app.use(cors())
app.use(cors({
  origin: ['http://tnsacademy.vercel.app','https://21stskills.vercel.app','https://21stskills.com','https://www.21stskills.com','https://university.21stskills.com','http://localhost:3333'], 
  credentials: true,
}));
